...
Namespace GridCommandToPopupMenuProject
    Friend Class PersonViewModel
        ...
        Public ReadOnly Property CreateNewPerson() As ICommand
            Get
                If createNewPerson_Renamed Is Nothing Then
                    createNewPerson_Renamed = New DevExpress.Xpf.Core.Commands.DelegateCommand(Of Person)(Sub(p) CreatePerson())
                End If
        ...
        Public ReadOnly Property DeletePerson() As ICommand
            Get
                If deletePerson_Renamed Is Nothing Then
                    deletePerson_Renamed = New DevExpress.Xpf.Core.Commands.DelegateCommand(Of Person)(Sub(p) DelPerson(), Function(o) CanDeletePerson())
                End If
        ...
        Public ReadOnly Property GoToFivePersonNext() As ICommand
            Get
                If goToFivePersonNext_Renamed Is Nothing Then
                    goToFivePersonNext_Renamed = New DevExpress.Xpf.Core.Commands.DelegateCommand(Of Person)(Sub(p) GoTo5PersonNext(), Function(o) CanGoToFivePersonNext())
                End If
        ...
        Private createNewPerson_Renamed As DevExpress.Xpf.Core.Commands.DelegateCommand(Of Person)

        Private deletePerson_Renamed As DevExpress.Xpf.Core.Commands.DelegateCommand(Of Person)

        Private goToFivePersonNext_Renamed As DevExpress.Xpf.Core.Commands.DelegateCommand(Of Person)
